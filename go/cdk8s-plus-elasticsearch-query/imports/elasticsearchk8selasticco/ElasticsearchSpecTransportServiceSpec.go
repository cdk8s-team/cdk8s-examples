...
type ElasticsearchSpecTransportServiceSpec struct {
	...
	Ports *[]*ElasticsearchSpecTransportServiceSpecPorts `field:"optional" json:"ports" yaml:"ports"`
	...
	SessionAffinityConfig *ElasticsearchSpecTransportServiceSpecSessionAffinityConfig `field:"optional" json:"sessionAffinityConfig" yaml:"sessionAffinityConfig"`
