...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("imports/io/cert_manager/$Module.txt");
    ...
    public $Module() {
        super("iocert-manager", "0.0.0", $Module.class, "iocert-manager@0.0.0.jsii.tgz");
    }
