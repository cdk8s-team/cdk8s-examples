 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.79.0 (build b22f628)", date = "2023-03-31T16:02:14.054Z")
@software.amazon.jsii.Jsii(module = imports.co.elastic.k8s.elasticsearch.$Module.class, fqn = "coelastick8selasticsearch.ElasticsearchSpecHttpServiceSpecPorts")
@software.amazon.jsii.Jsii.Proxy(ElasticsearchSpecHttpServiceSpecPorts.Jsii$Proxy.class)
public interface ElasticsearchSpecHttpServiceSpecPorts extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.co.elastic.k8s.elasticsearch.ElasticsearchSpecHttpServiceSpecPortsTargetPort getTargetPort() {
        return null;
    }

    /**
     * @return a {@link Builder} of {@link ElasticsearchSpecHttpServiceSpecPorts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ElasticsearchSpecHttpServiceSpecPorts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ElasticsearchSpecHttpServiceSpecPorts> {
        java.lang.Number port;
        java.lang.String name;
        java.lang.Number nodePort;
        java.lang.String protocol;
        imports.co.elastic.k8s.elasticsearch.ElasticsearchSpecHttpServiceSpecPortsTargetPort targetPort;

        /**
         * Sets the value of {@link ElasticsearchSpecHttpServiceSpecPorts#getPort}
        ...
        /**
         * Sets the value of {@link ElasticsearchSpecHttpServiceSpecPorts#getName}
        ...
        /**
         * Sets the value of {@link ElasticsearchSpecHttpServiceSpecPorts#getNodePort}
        ...
        /**
         * Sets the value of {@link ElasticsearchSpecHttpServiceSpecPorts#getProtocol}
        ...
        /**
         * Sets the value of {@link ElasticsearchSpecHttpServiceSpecPorts#getTargetPort}
         * @param targetPort Number or name of the port to access on the pods targeted by the service.
         *                   Number must be in the range 1 to 65535. Name must be an IANA_SVC_NAME. If this is a string, it will be looked up as a named port in the target Pod's container ports. If this is not specified, the value of the 'port' field is used (an identity map). This field is ignored for services with clusterIP=None, and should be omitted or set equal to the 'port' field. More info: https://kubernetes.io/docs/concepts/services-networking/service/#defining-a-service
         * @return {@code this}
         */
        public Builder targetPort(imports.co.elastic.k8s.elasticsearch.ElasticsearchSpecHttpServiceSpecPortsTargetPort targetPort) {
         ...
         * @return a new instance of {@link ElasticsearchSpecHttpServiceSpecPorts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ElasticsearchSpecHttpServiceSpecPorts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ElasticsearchSpecHttpServiceSpecPorts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ElasticsearchSpecHttpServiceSpecPorts {
        private final java.lang.Number port;
        private final java.lang.String name;
        private final java.lang.Number nodePort;
        private final java.lang.String protocol;
        private final imports.co.elastic.k8s.elasticsearch.ElasticsearchSpecHttpServiceSpecPortsTargetPort targetPort;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.targetPort = software.amazon.jsii.Kernel.get(this, "targetPort", software.amazon.jsii.NativeType.forClass(imports.co.elastic.k8s.elasticsearch.ElasticsearchSpecHttpServiceSpecPortsTargetPort.class));
        }
        ...
        @Override
        public final imports.co.elastic.k8s.elasticsearch.ElasticsearchSpecHttpServiceSpecPortsTargetPort getTargetPort() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("coelastick8selasticsearch.ElasticsearchSpecHttpServiceSpecPorts"));
        ...
        public final boolean equals(final Object o) {
            ...
            ElasticsearchSpecHttpServiceSpecPorts.Jsii$Proxy that = (ElasticsearchSpecHttpServiceSpecPorts.Jsii$Proxy) o;
