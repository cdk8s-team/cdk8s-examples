...
@software.amazon.jsii.Jsii(module = imports.co.elastic.k8s.elasticsearch.$Module.class, fqn = "coelastick8selasticsearch.ElasticsearchSpecHttpServiceSpec")
@software.amazon.jsii.Jsii.Proxy(ElasticsearchSpecHttpServiceSpec.Jsii$Proxy.class)
public interface ElasticsearchSpecHttpServiceSpec extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.co.elastic.k8s.elasticsearch.ElasticsearchSpecHttpServiceSpecPorts> getPorts() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.co.elastic.k8s.elasticsearch.ElasticsearchSpecHttpServiceSpecSessionAffinityConfig getSessionAffinityConfig() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link ElasticsearchSpecHttpServiceSpec}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ElasticsearchSpecHttpServiceSpec}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ElasticsearchSpecHttpServiceSpec> {
        ...
        java.util.List<imports.co.elastic.k8s.elasticsearch.ElasticsearchSpecHttpServiceSpecPorts> ports;
        ...
        imports.co.elastic.k8s.elasticsearch.ElasticsearchSpecHttpServiceSpecSessionAffinityConfig sessionAffinityConfig;
        java.util.List<java.lang.String> topologyKeys;
        java.lang.String type;

        /**
         * Sets the value of {@link ElasticsearchSpecHttpServiceSpec#getClusterIp}
        ...
        /**
         * Sets the value of {@link ElasticsearchSpecHttpServiceSpec#getExternalIPs}
        ...
        /**
         * Sets the value of {@link ElasticsearchSpecHttpServiceSpec#getExternalName}
        ...
        /**
         * Sets the value of {@link ElasticsearchSpecHttpServiceSpec#getExternalTrafficPolicy}
        ...
        /**
         * Sets the value of {@link ElasticsearchSpecHttpServiceSpec#getHealthCheckNodePort}
        ...
        /**
         * Sets the value of {@link ElasticsearchSpecHttpServiceSpec#getIpFamily}
        ...
        /**
         * Sets the value of {@link ElasticsearchSpecHttpServiceSpec#getLoadBalancerIp}
        ...
        /**
         * Sets the value of {@link ElasticsearchSpecHttpServiceSpec#getLoadBalancerSourceRanges}
        ...
        /**
         * Sets the value of {@link ElasticsearchSpecHttpServiceSpec#getPorts}
         * @param ports The list of ports that are exposed by this service.
         *              More info: https://kubernetes.io/docs/concepts/services-networking/service/#virtual-ips-and-service-proxies
         * @return {@code this}
         */
        @SuppressWarnings("unchecked")
        public Builder ports(java.util.List<? extends imports.co.elastic.k8s.elasticsearch.ElasticsearchSpecHttpServiceSpecPorts> ports) {
            this.ports = (java.util.List<imports.co.elastic.k8s.elasticsearch.ElasticsearchSpecHttpServiceSpecPorts>)ports;
            return this;
        }

        /**
         * Sets the value of {@link ElasticsearchSpecHttpServiceSpec#getPublishNotReadyAddresses}
        ...
        /**
         * Sets the value of {@link ElasticsearchSpecHttpServiceSpec#getSelector}
        ...
        /**
         * Sets the value of {@link ElasticsearchSpecHttpServiceSpec#getSessionAffinity}
        ...
        /**
         * Sets the value of {@link ElasticsearchSpecHttpServiceSpec#getSessionAffinityConfig}
         * @param sessionAffinityConfig sessionAffinityConfig contains the configurations of session affinity.
         * @return {@code this}
         */
        public Builder sessionAffinityConfig(imports.co.elastic.k8s.elasticsearch.ElasticsearchSpecHttpServiceSpecSessionAffinityConfig sessionAffinityConfig) {
            this.sessionAffinityConfig = sessionAffinityConfig;
            return this;
        }

        /**
         * Sets the value of {@link ElasticsearchSpecHttpServiceSpec#getTopologyKeys}
        ...
        /**
         * Sets the value of {@link ElasticsearchSpecHttpServiceSpec#getType}
         ...
         * @return a new instance of {@link ElasticsearchSpecHttpServiceSpec}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ElasticsearchSpecHttpServiceSpec build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ElasticsearchSpecHttpServiceSpec}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ElasticsearchSpecHttpServiceSpec {
        ...
        private final java.util.List<imports.co.elastic.k8s.elasticsearch.ElasticsearchSpecHttpServiceSpecPorts> ports;
        ...
        private final imports.co.elastic.k8s.elasticsearch.ElasticsearchSpecHttpServiceSpecSessionAffinityConfig sessionAffinityConfig;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.ports = software.amazon.jsii.Kernel.get(this, "ports", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.co.elastic.k8s.elasticsearch.ElasticsearchSpecHttpServiceSpecPorts.class)));
            ...
            this.sessionAffinityConfig = software.amazon.jsii.Kernel.get(this, "sessionAffinityConfig", software.amazon.jsii.NativeType.forClass(imports.co.elastic.k8s.elasticsearch.ElasticsearchSpecHttpServiceSpecSessionAffinityConfig.class));
        ...
        protected Jsii$Proxy(final Builder builder) {
            ...
            this.ports = (java.util.List<imports.co.elastic.k8s.elasticsearch.ElasticsearchSpecHttpServiceSpecPorts>)builder.ports;
        ...
        @Override
        public final java.util.List<imports.co.elastic.k8s.elasticsearch.ElasticsearchSpecHttpServiceSpecPorts> getPorts() {
            return this.ports;
        }
        ...
        @Override
        public final imports.co.elastic.k8s.elasticsearch.ElasticsearchSpecHttpServiceSpecSessionAffinityConfig getSessionAffinityConfig() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("coelastick8selasticsearch.ElasticsearchSpecHttpServiceSpec"));
        ...
        public final boolean equals(final Object o) {
            ...
            ElasticsearchSpecHttpServiceSpec.Jsii$Proxy that = (ElasticsearchSpecHttpServiceSpec.Jsii$Proxy) o;
