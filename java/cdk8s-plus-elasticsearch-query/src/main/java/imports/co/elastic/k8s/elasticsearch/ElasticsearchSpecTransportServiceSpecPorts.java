 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.79.0 (build b22f628)", date = "2023-03-31T16:02:14.064Z")
@software.amazon.jsii.Jsii(module = imports.co.elastic.k8s.elasticsearch.$Module.class, fqn = "coelastick8selasticsearch.ElasticsearchSpecTransportServiceSpecPorts")
@software.amazon.jsii.Jsii.Proxy(ElasticsearchSpecTransportServiceSpecPorts.Jsii$Proxy.class)
public interface ElasticsearchSpecTransportServiceSpecPorts extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.co.elastic.k8s.elasticsearch.ElasticsearchSpecTransportServiceSpecPortsTargetPort getTargetPort() {
        return null;
    }

    /**
     * @return a {@link Builder} of {@link ElasticsearchSpecTransportServiceSpecPorts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ElasticsearchSpecTransportServiceSpecPorts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ElasticsearchSpecTransportServiceSpecPorts> {
        java.lang.Number port;
        java.lang.String name;
        java.lang.Number nodePort;
        java.lang.String protocol;
        imports.co.elastic.k8s.elasticsearch.ElasticsearchSpecTransportServiceSpecPortsTargetPort targetPort;

        /**
         * Sets the value of {@link ElasticsearchSpecTransportServiceSpecPorts#getPort}
        ...
        /**
         * Sets the value of {@link ElasticsearchSpecTransportServiceSpecPorts#getName}
        ...
        /**
         * Sets the value of {@link ElasticsearchSpecTransportServiceSpecPorts#getNodePort}
        ...
        /**
         * Sets the value of {@link ElasticsearchSpecTransportServiceSpecPorts#getProtocol}
        ...
        /**
         * Sets the value of {@link ElasticsearchSpecTransportServiceSpecPorts#getTargetPort}
         * @param targetPort Number or name of the port to access on the pods targeted by the service.
         *                   Number must be in the range 1 to 65535. Name must be an IANA_SVC_NAME. If this is a string, it will be looked up as a named port in the target Pod's container ports. If this is not specified, the value of the 'port' field is used (an identity map). This field is ignored for services with clusterIP=None, and should be omitted or set equal to the 'port' field. More info: https://kubernetes.io/docs/concepts/services-networking/service/#defining-a-service
         * @return {@code this}
         */
        public Builder targetPort(imports.co.elastic.k8s.elasticsearch.ElasticsearchSpecTransportServiceSpecPortsTargetPort targetPort) {
         ...
         * @return a new instance of {@link ElasticsearchSpecTransportServiceSpecPorts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ElasticsearchSpecTransportServiceSpecPorts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ElasticsearchSpecTransportServiceSpecPorts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ElasticsearchSpecTransportServiceSpecPorts {
        private final java.lang.Number port;
        private final java.lang.String name;
        private final java.lang.Number nodePort;
        private final java.lang.String protocol;
        private final imports.co.elastic.k8s.elasticsearch.ElasticsearchSpecTransportServiceSpecPortsTargetPort targetPort;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.targetPort = software.amazon.jsii.Kernel.get(this, "targetPort", software.amazon.jsii.NativeType.forClass(imports.co.elastic.k8s.elasticsearch.ElasticsearchSpecTransportServiceSpecPortsTargetPort.class));
        }
        ...
        @Override
        public final imports.co.elastic.k8s.elasticsearch.ElasticsearchSpecTransportServiceSpecPortsTargetPort getTargetPort() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("coelastick8selasticsearch.ElasticsearchSpecTransportServiceSpecPorts"));
        ...
        public final boolean equals(final Object o) {
            ...
            ElasticsearchSpecTransportServiceSpecPorts.Jsii$Proxy that = (ElasticsearchSpecTransportServiceSpecPorts.Jsii$Proxy) o;
