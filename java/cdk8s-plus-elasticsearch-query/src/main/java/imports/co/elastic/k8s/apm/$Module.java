...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("imports/co/elastic/k8s/apm/$Module.txt");
    ...
    public $Module() {
        super("coelastick8sapm", "0.0.0", $Module.class, "coelastick8sapm@0.0.0.jsii.tgz");
    }
