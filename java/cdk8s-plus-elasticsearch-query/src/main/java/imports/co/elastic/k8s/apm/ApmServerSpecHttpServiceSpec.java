...
@software.amazon.jsii.Jsii(module = imports.co.elastic.k8s.apm.$Module.class, fqn = "coelastick8sapm.ApmServerSpecHttpServiceSpec")
@software.amazon.jsii.Jsii.Proxy(ApmServerSpecHttpServiceSpec.Jsii$Proxy.class)
public interface ApmServerSpecHttpServiceSpec extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.co.elastic.k8s.apm.ApmServerSpecHttpServiceSpecPorts> getPorts() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.co.elastic.k8s.apm.ApmServerSpecHttpServiceSpecSessionAffinityConfig getSessionAffinityConfig() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link ApmServerSpecHttpServiceSpec}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ApmServerSpecHttpServiceSpec}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ApmServerSpecHttpServiceSpec> {
        ...
        java.util.List<imports.co.elastic.k8s.apm.ApmServerSpecHttpServiceSpecPorts> ports;
        ...
        imports.co.elastic.k8s.apm.ApmServerSpecHttpServiceSpecSessionAffinityConfig sessionAffinityConfig;
        java.util.List<java.lang.String> topologyKeys;
        java.lang.String type;

        /**
         * Sets the value of {@link ApmServerSpecHttpServiceSpec#getClusterIp}
        ...
        /**
         * Sets the value of {@link ApmServerSpecHttpServiceSpec#getExternalIPs}
        ...
        /**
         * Sets the value of {@link ApmServerSpecHttpServiceSpec#getExternalName}
        ...
        /**
         * Sets the value of {@link ApmServerSpecHttpServiceSpec#getExternalTrafficPolicy}
        ...
        /**
         * Sets the value of {@link ApmServerSpecHttpServiceSpec#getHealthCheckNodePort}
        ...
        /**
         * Sets the value of {@link ApmServerSpecHttpServiceSpec#getIpFamily}
        ...
        /**
         * Sets the value of {@link ApmServerSpecHttpServiceSpec#getLoadBalancerIp}
        ...
        /**
         * Sets the value of {@link ApmServerSpecHttpServiceSpec#getLoadBalancerSourceRanges}
        ...
        /**
         * Sets the value of {@link ApmServerSpecHttpServiceSpec#getPorts}
         * @param ports The list of ports that are exposed by this service.
         *              More info: https://kubernetes.io/docs/concepts/services-networking/service/#virtual-ips-and-service-proxies
         * @return {@code this}
         */
        @SuppressWarnings("unchecked")
        public Builder ports(java.util.List<? extends imports.co.elastic.k8s.apm.ApmServerSpecHttpServiceSpecPorts> ports) {
            this.ports = (java.util.List<imports.co.elastic.k8s.apm.ApmServerSpecHttpServiceSpecPorts>)ports;
            return this;
        }

        /**
         * Sets the value of {@link ApmServerSpecHttpServiceSpec#getPublishNotReadyAddresses}
        ...
        /**
         * Sets the value of {@link ApmServerSpecHttpServiceSpec#getSelector}
        ...
        /**
         * Sets the value of {@link ApmServerSpecHttpServiceSpec#getSessionAffinity}
        ...
        /**
         * Sets the value of {@link ApmServerSpecHttpServiceSpec#getSessionAffinityConfig}
         * @param sessionAffinityConfig sessionAffinityConfig contains the configurations of session affinity.
         * @return {@code this}
         */
        public Builder sessionAffinityConfig(imports.co.elastic.k8s.apm.ApmServerSpecHttpServiceSpecSessionAffinityConfig sessionAffinityConfig) {
            this.sessionAffinityConfig = sessionAffinityConfig;
            return this;
        }

        /**
         * Sets the value of {@link ApmServerSpecHttpServiceSpec#getTopologyKeys}
        ...
        /**
         * Sets the value of {@link ApmServerSpecHttpServiceSpec#getType}
         ...
         * @return a new instance of {@link ApmServerSpecHttpServiceSpec}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ApmServerSpecHttpServiceSpec build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ApmServerSpecHttpServiceSpec}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ApmServerSpecHttpServiceSpec {
        ...
        private final java.util.List<imports.co.elastic.k8s.apm.ApmServerSpecHttpServiceSpecPorts> ports;
        ...
        private final imports.co.elastic.k8s.apm.ApmServerSpecHttpServiceSpecSessionAffinityConfig sessionAffinityConfig;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.ports = software.amazon.jsii.Kernel.get(this, "ports", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.co.elastic.k8s.apm.ApmServerSpecHttpServiceSpecPorts.class)));
            ...
            this.sessionAffinityConfig = software.amazon.jsii.Kernel.get(this, "sessionAffinityConfig", software.amazon.jsii.NativeType.forClass(imports.co.elastic.k8s.apm.ApmServerSpecHttpServiceSpecSessionAffinityConfig.class));
        ...
        protected Jsii$Proxy(final Builder builder) {
            ...
            this.ports = (java.util.List<imports.co.elastic.k8s.apm.ApmServerSpecHttpServiceSpecPorts>)builder.ports;
        ...
        @Override
        public final java.util.List<imports.co.elastic.k8s.apm.ApmServerSpecHttpServiceSpecPorts> getPorts() {
            return this.ports;
        }
        ...
        @Override
        public final imports.co.elastic.k8s.apm.ApmServerSpecHttpServiceSpecSessionAffinityConfig getSessionAffinityConfig() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("coelastick8sapm.ApmServerSpecHttpServiceSpec"));
        ...
        public final boolean equals(final Object o) {
            ...
            ApmServerSpecHttpServiceSpec.Jsii$Proxy that = (ApmServerSpecHttpServiceSpec.Jsii$Proxy) o;
