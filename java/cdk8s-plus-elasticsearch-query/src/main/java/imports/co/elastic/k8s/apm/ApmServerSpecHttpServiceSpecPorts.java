 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.79.0 (build b22f628)", date = "2023-03-31T16:02:12.129Z")
@software.amazon.jsii.Jsii(module = imports.co.elastic.k8s.apm.$Module.class, fqn = "coelastick8sapm.ApmServerSpecHttpServiceSpecPorts")
@software.amazon.jsii.Jsii.Proxy(ApmServerSpecHttpServiceSpecPorts.Jsii$Proxy.class)
public interface ApmServerSpecHttpServiceSpecPorts extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.co.elastic.k8s.apm.ApmServerSpecHttpServiceSpecPortsTargetPort getTargetPort() {
        return null;
    }

    /**
     * @return a {@link Builder} of {@link ApmServerSpecHttpServiceSpecPorts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ApmServerSpecHttpServiceSpecPorts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ApmServerSpecHttpServiceSpecPorts> {
        java.lang.Number port;
        java.lang.String name;
        java.lang.Number nodePort;
        java.lang.String protocol;
        imports.co.elastic.k8s.apm.ApmServerSpecHttpServiceSpecPortsTargetPort targetPort;

        /**
         * Sets the value of {@link ApmServerSpecHttpServiceSpecPorts#getPort}
        ...
        /**
         * Sets the value of {@link ApmServerSpecHttpServiceSpecPorts#getName}
        ...
        /**
         * Sets the value of {@link ApmServerSpecHttpServiceSpecPorts#getNodePort}
        ...
        /**
         * Sets the value of {@link ApmServerSpecHttpServiceSpecPorts#getProtocol}
        ...
        /**
         * Sets the value of {@link ApmServerSpecHttpServiceSpecPorts#getTargetPort}
         * @param targetPort Number or name of the port to access on the pods targeted by the service.
         *                   Number must be in the range 1 to 65535. Name must be an IANA_SVC_NAME. If this is a string, it will be looked up as a named port in the target Pod's container ports. If this is not specified, the value of the 'port' field is used (an identity map). This field is ignored for services with clusterIP=None, and should be omitted or set equal to the 'port' field. More info: https://kubernetes.io/docs/concepts/services-networking/service/#defining-a-service
         * @return {@code this}
         */
        public Builder targetPort(imports.co.elastic.k8s.apm.ApmServerSpecHttpServiceSpecPortsTargetPort targetPort) {
         ...
         * @return a new instance of {@link ApmServerSpecHttpServiceSpecPorts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ApmServerSpecHttpServiceSpecPorts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ApmServerSpecHttpServiceSpecPorts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ApmServerSpecHttpServiceSpecPorts {
        private final java.lang.Number port;
        private final java.lang.String name;
        private final java.lang.Number nodePort;
        private final java.lang.String protocol;
        private final imports.co.elastic.k8s.apm.ApmServerSpecHttpServiceSpecPortsTargetPort targetPort;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.targetPort = software.amazon.jsii.Kernel.get(this, "targetPort", software.amazon.jsii.NativeType.forClass(imports.co.elastic.k8s.apm.ApmServerSpecHttpServiceSpecPortsTargetPort.class));
        }
        ...
        @Override
        public final imports.co.elastic.k8s.apm.ApmServerSpecHttpServiceSpecPortsTargetPort getTargetPort() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("coelastick8sapm.ApmServerSpecHttpServiceSpecPorts"));
        ...
        public final boolean equals(final Object o) {
            ...
            ApmServerSpecHttpServiceSpecPorts.Jsii$Proxy that = (ApmServerSpecHttpServiceSpecPorts.Jsii$Proxy) o;
