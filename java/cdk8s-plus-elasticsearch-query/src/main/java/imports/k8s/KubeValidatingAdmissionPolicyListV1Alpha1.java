...
public class KubeValidatingAdmissionPolicyListV1Alpha1 extends org.cdk8s.ApiObject {
     ...
     */
    public KubeValidatingAdmissionPolicyListV1Alpha1(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.k8s.KubeValidatingAdmissionPolicyListV1Alpha1Props props) {
     ...
     * @param id a scope-local name for the object. This parameter is required.
     */
    public KubeValidatingAdmissionPolicyListV1Alpha1(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
     ...
     * @param props initialization props.
     */
    public static @org.jetbrains.annotations.NotNull java.lang.Object manifest(final @org.jetbrains.annotations.Nullable imports.k8s.KubeValidatingAdmissionPolicyListV1Alpha1Props props) {
        return software.amazon.jsii.JsiiObject.jsiiStaticCall(imports.k8s.KubeValidatingAdmissionPolicyListV1Alpha1.class, "manifest", software.amazon.jsii.NativeType.forClass(java.lang.Object.class), new Object[] { props });
    }
    ...
    public static @org.jetbrains.annotations.NotNull java.lang.Object manifest() {
        return software.amazon.jsii.JsiiObject.jsiiStaticCall(imports.k8s.KubeValidatingAdmissionPolicyListV1Alpha1.class, "manifest", software.amazon.jsii.NativeType.forClass(java.lang.Object.class));
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<imports.k8s.KubeValidatingAdmissionPolicyListV1Alpha1> {
        ...
        private imports.k8s.KubeValidatingAdmissionPolicyListV1Alpha1Props.Builder props;
        ...
        /**
         * @returns a newly built instance of {@link imports.k8s.KubeValidatingAdmissionPolicyListV1Alpha1}.
         */
        @Override
