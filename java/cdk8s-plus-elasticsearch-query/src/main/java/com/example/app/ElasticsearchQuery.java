                        ...
                        .spec(ElasticsearchSpec.builder()
                                ...
                                .http(ElasticsearchSpecHttp.builder()
                                        .service(ElasticsearchSpecHttpService.builder()
                                                .spec(ElasticsearchSpecHttpServiceSpec.builder()
                                                        .ports(List.of(ElasticsearchSpecHttpServiceSpecPorts.builder()
                                                                .port(esPort)
                                                                .build()))
                                                        .build())
                                                .build())
                                        .tls(ElasticsearchSpecHttpTls.builder()
                                                .selfSignedCertificate(ElasticsearchSpecHttpTlsSelfSignedCertificate.builder()
                                                        .disabled(true)
                                                        .build())
                                                .build())
                                        .build())
