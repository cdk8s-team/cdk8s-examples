...
public class PodInfo extends Chart {

        public PodInfo(final Construct scope, final String id) {
                this(scope, id, null);
        }

        public PodInfo(final Construct scope, final String id, final ChartProps props) {
                ...
                Container container = deployment.addContainer(ContainerProps.builder()
                                ...
                                .command(List.of("./podinfo", "--port=" + portNumber, "--level=info",
                                                "--random-error=true"))
                                .imagePullPolicy(ImagePullPolicy.IF_NOT_PRESENT)
                                .portNumber(portNumber)
                                .liveness(Probe.fromCommand(
                                                List.of("podcli", "check", "http",
                                                                "localhost:" + portNumber + "/healthz"),
