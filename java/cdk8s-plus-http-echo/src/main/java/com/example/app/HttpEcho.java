...
public class HttpEcho extends Chart {

        public HttpEcho(final Construct scope, final String id) {
                this(scope, id, null);
        }

        public HttpEcho(final Construct scope, final String id, final ChartProps props) {
