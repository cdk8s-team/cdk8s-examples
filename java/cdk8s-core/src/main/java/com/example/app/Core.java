...
public class Core extends Chart {

    public Core(final Construct scope, final String id) {
        this(scope, id, null);
    }

    public Core(final Construct scope, final String id, final ChartProps props) {
